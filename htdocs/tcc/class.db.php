...
define('DB_PASS', 'minas'); // set database password
define('DB_NAME', 'suporte'); // set database name
define('SEND_ERRORS_TO', 'thalesmoraes60@gmail.com' ); //set email notification email address
